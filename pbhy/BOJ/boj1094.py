...
1. 지민이가 가지고 있는 막대의 길이를 모두 더한다. 처음에는 64cm 막대 하나만 가지고 있다. 이때, 합이 X보다 크다면, 아래와 같은 과정을 반복한다.
    a. 가지고 있는 막대 중 길이가 가장 짧은 것을 절반으로 자른다.
    b. 만약, 위에서 자른 막대의 절반 중 하나를 버리고 남아있는 막대의 길이의 합이 X보다 크거나 같다면, 위에서 자른 막대의 절반 중 하나를 버린다.
...
64를 2의 거듭제곱 단위로 나눠서 X에 맞게 더하는 것.
-> x를 계속 2로 나눠서 나머지가 1인 갯수를 센다.
--> 이진법 계산의 원리
'''
x = int(input())
cnt = 0
