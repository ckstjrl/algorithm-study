...
B 학교에서는 모든 학생에게 사과를 한 개씩 나눠주고 9개의 사과가 남게 된다. 비슷하게 C 학교에서는 3개의 사과가, 
D 학교에서는 10개의 사과가, E 학교에서는 0개의 사과가 남게 되어, 남는 사과의 총 수는 4+9+3+10+0 = 26이다. 
...
for i in range(n):   # 학교의 수 만큼 배달 
    student, apple = map(int, input().split())
    ans += apple % student # 사과 나누기 학생수 한 나머지 값을 ans에 누적하기 
